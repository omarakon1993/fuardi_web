    ...
    <>
      ...
      <Container className="py-12 md:py-16">
        <div className="max-w-3xl">
          <p
            role="note"
            className="flex gap-3 rounded-lg border-2 border-amarillo bg-amarillo/15 p-5 text-lg"
          >
            ...
            <ul className="mt-3 space-y-1">
              {politica.secciones.map((s) => (
                <li key={s.id}>
                  <a
                    href={`#${s.id}`}
                    className="inline-flex min-h-11 items-center text-azul underline decoration-2 underline-offset-4"
                  >
                    {s.titulo}
                  </a>
                </li>
