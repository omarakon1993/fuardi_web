...
export function Footer() {
  ...
  return (
    <footer
      aria-labelledby="pie-titulo"
      className="relative -mt-14 rounded-t-capa bg-tinta text-blanco"
    >
      <Container className="grid gap-12 pt-20 pb-14 md:pt-24 lg:grid-cols-[1.15fr_1fr] lg:gap-16">
        <Revelar>
          ...
          <p className="mt-6 medida text-entrada text-blanco/90">{pie.texto}</p>
        ...
        <dl className="grid content-start gap-x-10 gap-y-8 sm:grid-cols-2 lg:pt-6">
          ...
          <div>
            ...
            <dd className="mt-1">
              <a href={enlaceCorreo()} className={cx(enlaceClaro, "break-all")}>
                {site.correo}
              </a>
            </dd>
          </div>
