...
const trazos = {
  whatsapp: (
    <>
      ...
      <path d="M9 8.6c0 3.4 2.9 6.4 6.4 6.4l1-1.6-2-1-1 .8a4.4 4.4 0 0 1-2.2-2.2l.8-1-1-2Z" />
    </>
  ),
  facebook: (
  ...
  tiktok: (
    <path d="M14 3v11.5a3.5 3.5 0 1 1-3.5-3.5M14 3c.4 2.8 2.4 4.6 5 4.8" />
  ),
  youtube: (
    <>
  ...
  participacion: (
    <>
      ...
      <path d="M5 9v8c0 1.7 3.1 3 7 3s7-1.3 7-3V9M3 2l5 5M21 2l-5 5" />
    </>
  ),
  medios: (
    <>
  ...
  verificado: <path d="M20 6 9 17l-5-5" />,
  alerta: (
    <>
      <circle cx="12" cy="12" r="10" />
...
/** Ícono decorativo. El texto accesible va en el elemento que lo contiene. */
export function Icon({ nombre, tamano = 24, ...props }: IconProps) {
  return (
    <svg
